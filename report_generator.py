...
def generate_incident_pdf(log_data):
    """
    Generates a professional PDF Incident Report for a specific attack.
    ...
    # Text wrapping for long payloads so it doesn't run off the page
    ...
    for line in wrapped_payload[:10]: # Print up to 10 lines of payload to save space
